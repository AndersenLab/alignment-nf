...
```{r load}
STRAIN_PATH <- "_aggregate/multiqc/strain_data/"

sample_sheet <- data.table::fread("sample_sheet.tsv")
...
## Downloads 
* [Reads Mapped By Strain](reads_mapped_by_strain.tsv)
...
DT::datatable(mapped,
              ...
              options = list(pageLength = 5000, scrollY = 400),
              extensions = c("Scroller"))

data.table::fwrite(mapped, "reads_mapped_by_strain.tsv", sep = "\t")
```

Download [reads_mapped_by_strain.tsv](reads_mapped_by_strain.tsv)
