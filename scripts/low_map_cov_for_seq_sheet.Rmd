...
dplyr::inner_join(gatk_sample_sheet, dplyr::select(ss, strain, avg_coverage, reads_mapped_percent), by=c("V1"="strain")) %>% write.table("sample_sheet_for_seq_sheet_ALL.tsv", quote=F, col.names = F, row.names = F, sep="\t")
...
dplyr::inner_join(gatk_sample_sheet, dplyr::select(ss, strain, avg_coverage, reads_mapped_percent), by=c("V1"="strain")) %>% 
    ...
    write.table("sample_sheet_for_seq_sheet.tsv", quote=F, col.names = F, row.names = F, sep="\t")
